...
exp_time = 20 
input_path = '/mnt/dwf/archive_NOAO_data/data_outputs/2015/12/CDF-S/g_band/single/*/SE_cats/'
input_cats = '/mnt/dwf/sky_mapperDR2/shortlisted_stars_for_photom/CDFS_SkyM.csv_SHORTLISTED.ascii'
