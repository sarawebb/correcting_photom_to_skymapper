...
exp_time = 20 
input_path = '/mnt/dwf/archive_NOAO_data/data_outputs/2018/06/8hr/g_band/single/*/SE_cats/'
input_cats = '/mnt/dwf/sky_mapperDR2/shortlisted_stars_for_photom/8hr_SkyM.csv_SHORTLISTED.ascii'
