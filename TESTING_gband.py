...
for i in path_list: 
	for filename in os.listdir(i):
		...
		MAG_APER, MAGERR_APER, MAG_AUTO, MAGERR_AUTO, XPEAK_IMAGE, YPEAK_IMAGE, X_IMAGE, Y_IMAGE, ALPHA_J2000, DELTA_J2000 = np.loadtxt(str(i) + str(filename, unpack = True, skiprows = 1)
		...
		os.chdir(i)
		filename_directory = os.chdir("..")
		#print(os.path.abspath(os.curdir))
	
		photom_correction_path = str(filename_directory) + '/photom_correction_files'
