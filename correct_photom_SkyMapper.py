"""correct_photom_SkyMapper.py -- Input a year, month, and field for data that has had their source extractor to correct each ccds catalo
for exposure time and standard star offsets against skymapper catalogs . 

Usage: correct_photom_SkyMapper [-h] [-v] [--debug] <year> <month> <field> <exp_time>
...
Arguments:
	...
	exp_time (integer)
		The exposure time of each of the exposures in seconds. 
Options:
	-h, --help                              Show this screen
	-v, --verbose                           	Show extra information [default: False]     
	--debug                                 Output more for debugging [default: False]
Example:
	python /fred/oz100/NOAO_archive/archive_NOAO_data/scripts/correct_photom/correct_photom_SkyMapper.py -v 2015 01 4hr 20
"""
...
if __name__ == "__main__":
	...
	exp_time = arguments['<exp_time>']
	exp_time = int(exp_time)	
	#verbose = arguments['--verbose']
	debugmode = arguments['--debug']

	#print(year, month, field, exp_time)	
	if debugmode:
		print(arguments)
	correct_photom_SkyMapper(year, month, field, exp_time, verbose=True, debugmode=debugmode)			
