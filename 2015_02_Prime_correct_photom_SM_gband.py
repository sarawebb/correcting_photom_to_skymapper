...
exp_time = 20 
input_path = '/mnt/dwf/archive_NOAO_data/data_outputs/2015/02/Prime_field/g_band/single/*/SE_cats/'
input_cats = '/mnt/dwf/sky_mapperDR2/shortlisted_stars_for_photom/Prime_SkyM.csv_SHORTLISTED.ascii'
